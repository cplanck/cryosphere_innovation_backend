...
# import requests
# url = 'http://localhost:8000/public/deployment/data/b3a08acc-b797-4e21-bf50-ab9d0dce244b'; 
# response = requests.get(url, headers={'AUTHENTICATION':regular_api_key}).json()
# print(response)


import requests
url = 'http://localhost:8000/public/deployment/data/5000dcd1-7f1a-465c-9ccc-cf707566d0bc'; 
response = requests.get(url, headers={'AUTHENTICATION':bears_api_key}).json()
print(response)